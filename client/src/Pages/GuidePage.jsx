        ...
        <section className="w-full py-12 px-6 sm:px-12 bg-white min-h-[60vh] relative">
          <div className="max-w-4xl mx-auto relative">
            ...
            <div className="mb-36 sm:mb-16 min-h-[400px] relative overflow-hidden">
              {isMobile && (
                <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 z-20 px-6 py-4 sm:hidden">
                  <div className="max-w-4xl mx-auto flex justify-between">
                    <button
                      onClick={goToPrevStep}
                      disabled={currentStep === 0 || isTransitioning || navigationCooldown}
                      className="px-4 py-2 rounded-md bg-gray-200 text-sm text-[#1A3D61] font-medium disabled:opacity-50"
                    >
                      Back
                    </button>
                    <button
                      ...
                      className="px-4 py-2 rounded-md bg-[#1A3D61] text-white text-sm font-medium disabled:opacity-50"
                    >
                      Next
                    </button>
                  </div>
